        ...
        <>
           {allProducts.length === 0 ? <Loading/> :<div className="bg-white mt-10 p-10 m-auto flex flex-col">
            ...
            <div className="flex relative">
                <input type="text" id="search" placeholder="Search here" onChange={(e)=> setsearch(e.target.value)} className="border-b-blue-700 border-1 rounded-2xl w-42 px-2 py-1"/>
         ...
         {Productdata.length === 0? (<p className="mt-6 self-center text-blue-500/90 text-[18px] md:text-2xl">No products match your search.</p>): 
